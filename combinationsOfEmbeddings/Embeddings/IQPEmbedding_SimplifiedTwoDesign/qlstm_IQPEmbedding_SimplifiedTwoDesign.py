...
class QLSTM_IQPEmbedding_SimplifiedTwoDesign(nn.Module):
    def __init__(self, input_size, hidden_size, n_qubits=4, n_qlayers=1, batch_first=True, return_sequences=False, return_state=False, backend="default.qubit"):
        ...
        def _circuit_input(inputs, weights):
            qml.templates.IQPEmbedding(inputs, wires=self.wires_input)
        ...
        def _circuit_output(inputs, weights):
            qml.templates.IQPEmbedding(inputs, wires=self.wires_output)
